    ...
    public sendEmail = async (
        ...
        try {
            ...
            if (isFirstVerifiedEMail) {
                ...
                if (isExeededLast) {
                    console.log("2 depth 조건문-a : 제한일까지 사용 금지");
                ...
                if (isExceededNow) {
                    console.log("2 depth 조건문-b : 제한일까지 사용 금지");
